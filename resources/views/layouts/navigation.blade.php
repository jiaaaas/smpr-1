<nav x-data="{ open: false }" class="bg-dark1 border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="bg-dark1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logoamtis.jpg') }}" class="block h-9 w-auto" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('performanceReport.index')" :active="request()->routeIs('performanceReport.index')">
